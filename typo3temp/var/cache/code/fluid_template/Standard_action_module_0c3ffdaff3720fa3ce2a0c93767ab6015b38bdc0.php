...
class Standard_action_module_0c3ffdaff3720fa3ce2a0c93767ab6015b38bdc0 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$array3['2'] = ' && ';
$array5 = array (
);$array3['3'] = $renderingContext->getVariableProvider()->getByPath('hasModules', $array5);
...
$array9 = array (
);return $renderingContext->getVariableProvider()->getByPath('topbar', $array9);
};
$arguments7 = array();
...
$array18 = array (
);return $renderingContext->getVariableProvider()->getByPath('moduleMenu', $array18);
};
$arguments16 = array();
...
$array12 = array();
$array13 = array (
);$array12['0'] = $renderingContext->getVariableProvider()->getByPath('hasModules', $array13);
...
$array21['0'] = '!';
$array22 = array (
);$array21['1'] = $renderingContext->getVariableProvider()->getByPath('hasModules', $array22);
...
$arguments19['then'] = 'scaffold-no-modules';
...
$arguments24['key'] = 'LLL:EXT:core/Resources/Private/Language/locallang_core.xlf:iframe.navFrame';
...
$output0 .= '" scrolling="no" class="scaffold-content-navigation-iframe t3js-scaffold-content-navigation-iframe"></iframe>
        ...
        <div class="scaffold-content-module t3js-scaffold-content-module">
            <iframe name="list_frame" id="typo3-contentIframe" title="';
// Rendering ViewHelper TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper
...
$arguments26['key'] = 'LLL:EXT:core/Resources/Private/Language/locallang_core.xlf:iframe.listFrame';
...
$output0 .= '" scrolling="no" class="scaffold-content-module-iframe t3js-scaffold-content-module-iframe"></iframe>
        </div>
