...
class partial_Structure_CookieConsent_feb553a870ae8ebf8d4d2b10e1988fd519f9ceca extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output6 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('theme.cookieconsent.cookie.expiryDays', $array7)]);
...
$arguments8['key'] = 'cookieconsent.common.header';
$arguments8['extensionName'] = 'bootstrap_package';
...
$arguments10['key'] = 'cookieconsent.common.message';
...
$arguments12['key'] = 'cookieconsent.common.dismiss';
$arguments12['extensionName'] = 'bootstrap_package';
...
$arguments14['key'] = 'cookieconsent.common.allow';
...
$arguments16['key'] = 'cookieconsent.common.deny';
$arguments16['extensionName'] = 'bootstrap_package';
...
$arguments18['key'] = 'cookieconsent.common.link';
$arguments18['extensionName'] = 'bootstrap_package';

$output6 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments18, $renderChildrenClosure19, $renderingContext)]);
...
$array22 = array (
);$arguments20['parameter'] = $renderingContext->getVariableProvider()->getByPath('theme.cookieconsent.content.href', $array22);

$output6 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [TYPO3\CMS\Fluid\ViewHelpers\Uri\TypolinkViewHelper::renderStatic($arguments20, $renderChildrenClosure21, $renderingContext)]);

$output6 .= '"></span>
    <span data-cookieconsent-setting="layout" data-cookieconsent-value="';
$array23 = array (
);
$output6 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('theme.cookieconsent.layout', $array23)]);

$output6 .= '"></span>
    <span data-cookieconsent-setting="type" data-cookieconsent-value="';
$array24 = array (
);
$output6 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('theme.cookieconsent.type', $array24)]);

$output6 .= '"></span>
    <span data-cookieconsent-setting="position" data-cookieconsent-value="';
$array25 = array (
);
$output6 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('theme.cookieconsent.position', $array25)]);

$output6 .= '"></span>
    <span data-cookieconsent-setting="revokable" data-cookieconsent-value="';
$array26 = array (
);
$output6 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('theme.cookieconsent.revokable', $array26)]);

$output6 .= '"></span>
    <span data-cookieconsent-setting="static" data-cookieconsent-value="';
$array27 = array (
);
$output6 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('theme.cookieconsent.static', $array27)]);

$output6 .= '"></span>
    <span data-cookieconsent-setting="location" data-cookieconsent-value="';
$array28 = array (
);
$output6 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('theme.cookieconsent.location', $array28)]);

$output6 .= '"></span>
    <span data-cookieconsent-setting="law.countryCode" data-cookieconsent-value="';
$array29 = array (
);
$output6 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('theme.cookieconsent.law.countryCode', $array29)]);

$output6 .= '"></span>
    <span data-cookieconsent-setting="law.regionalLaw" data-cookieconsent-value="';
$array30 = array (
);
$output6 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('theme.cookieconsent.law.regionalLaw', $array30)]);
...
$array3 = array();
$array4 = array (
);$array3['0'] = $renderingContext->getVariableProvider()->getByPath('theme.cookieconsent.enable', $array4);
