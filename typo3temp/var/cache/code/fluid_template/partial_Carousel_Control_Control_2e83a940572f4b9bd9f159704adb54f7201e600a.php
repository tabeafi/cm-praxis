...
class partial_Carousel_Control_Control_2e83a940572f4b9bd9f159704adb54f7201e600a extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output8 .= '
    <a data-slide="prev" role="button" class="left carousel-control carousel-control-prev" href="#carousel-';
$array9 = array (
);
...
$output8 .= '</span>
    ...
    <a data-slide="next" role="button" class="right carousel-control carousel-control-next" href="#carousel-';
$array12 = array (
);
$output8 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('data.uid', $array12)]);
