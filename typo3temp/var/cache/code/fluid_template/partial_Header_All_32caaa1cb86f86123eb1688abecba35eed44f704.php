...
class partial_Header_All_32caaa1cb86f86123eb1688abecba35eed44f704 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$array48 = array (
);$array46['format'] = $renderingContext->getVariableProvider()->getByPath('settings.header.date.format', $array48);
// Rendering ViewHelper TYPO3Fluid\Fluid\ViewHelpers\IfViewHelper
...
$array51 = array();
$array52 = array (
);$array51['0'] = $renderingContext->getVariableProvider()->getByPath('data.header_position', $array52);
...
$output54 .= $renderingContext->getVariableProvider()->getByPath('data.header_position', $array55);
$arguments49['then'] = $output54;
$array46['positionClass'] = TYPO3Fluid\Fluid\ViewHelpers\IfViewHelper::renderStatic($arguments49, $renderChildrenClosure50, $renderingContext);
